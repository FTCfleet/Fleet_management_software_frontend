...
import { Typography, Box, Container, useTheme, useMediaQuery, TextField, MenuItem, Select, FormControl } from "@mui/material";
...
const ServicesPage = () => {
  ...
  const handleSubmit = (e) => { e.preventDefault(); console.log("Form submitted:", formData); toast.success("Thank you! Your enquiry has been submitted. Our team will contact you soon.", { position: "bottom-right" }); setFormData({ name: "", phone: "", serviceType: "", pickupLocation: "", deliveryLocation: "", goodsDescription: "" }); };
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeIn}>
          <GlassCard sx={{ p: { xs: 3, md: 5 } }}>
            ...
            <Box component="form" onSubmit={handleSubmit} sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
              ...
              <TextField name="goodsDescription" label="Goods Description" value={formData.goodsDescription} onChange={handleInputChange} required multiline rows={3} fullWidth InputProps={{ startAdornment: <FaClipboardList style={{ marginRight: 10, marginTop: 8, color: "rgba(255,255,255,0.4)", alignSelf: "flex-start" }} /> }} sx={inputStyle} />
              <motion.button type="submit" whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} style={{ background: "linear-gradient(135deg, #FFB74D 0%, #FF9800 100%)", border: "none", borderRadius: "14px", padding: "16px 32px", color: "#1D3557", fontWeight: 700, fontSize: "1rem", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "10px", boxShadow: "0 8px 25px rgba(255, 183, 77, 0.35)", width: "100%" }}>Submit Enquiry <FaArrowRight /></motion.button>
            </Box>
          </GlassCard>
        </motion.div>
      </Container>
