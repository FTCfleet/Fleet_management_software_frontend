...
const HomePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Friends Transport | Transport Company in Hyderabad | Truck Booking & Logistics</title>
        <meta
          name="description"
          content="Friends Transport Company provides truck transport, parcel delivery, logistics and goods transport services in Hyderabad across India with safe and reliable delivery."
        />
