...
const DashboardPage = () => {
  ...
  const handleChangePassword = async () => {
    if (newPassword.length === 0 || oldPassword.length === 0 || confirmPassword !== newPassword) {
  ...
  return user ? (
    ...
    >
      ...
      <Modal open={openModal} onClose={handleCloseModal}>
        ...
        >
          <Typography id="change-password-modal" variant="h6" component="h2" color="black" mb="10px">
            Change Password
          </Typography>
          <TextField
